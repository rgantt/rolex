...
class profiler_test extends \PHPUnit_Framework_TestCase {
    ...
    public function test_facade_run_retains_message() {
        $str = "test";
        $this->assertContains( $str, r::run( $str, function() { return false; } )->message );
    }
    
    public function test_facade_run_returns_result() {
        $this->assertTrue( r::run( "test", function() { return true; } ) instanceof result );
    }
    
    public function test_facade_add_result() {
    ...
    public function test_facade_clear_results_saves_results() {
        $this->add_results();
        $results = r::clear();
    ...
    public function test_facade_clear_results_clears_results() {
        $this->add_results();
        r::clear();
        $this->assertEquals( array(), r::results() );
    }
    
    public function test_facade_results() {
        $this->add_results();
        $results = r::results();
        $this->assertEquals( 2, count( $results ) );
        $this->assertEquals( "first", $results[0]->message );
    ...
    public function test_facade_start_and_stop() {
    ...
    public function test_facade_nested_start_stop() {
    ...
    public function test_facade_staggered_start_stop() {
    ...
    public function test_facade_unterminated_timer() {
